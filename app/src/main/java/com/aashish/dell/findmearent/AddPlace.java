...
public class AddPlace extends AppCompatActivity implements LocationListener {
    ...
    private String UPLOAD_URL = config.Localhost+"/addplace.php";
    ...
    @Bind(R.id.type) RadioGroup _type;
 //   @Bind(R.id.status) RadioGroup _status;
    ...
    @Bind(R.id.buttonUpload) Button _upload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCapturePicture1 = (ImageButton) findViewById(R.id.imageView1);
        btnCapturePicture2 = (ImageButton) findViewById(R.id.imageView2);
        btnCapturePicture3 = (ImageButton) findViewById(R.id.imageView3);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        Toast.makeText(AddPlace.this, s , Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        //Showing toast
                        Toast.makeText(AddPlace.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
